...
BEGIN
    DECLARE v_current_date DATE;  -- Changed from current_date to v_current_date
    DECLARE date_key_val INT;
    
    SET v_current_date = start_date;
    
    WHILE v_current_date <= end_date DO
        SET date_key_val = YEAR(v_current_date) * 10000 + 
